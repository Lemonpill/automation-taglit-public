...
from src.elements.loginpage import (
    CookiesAcceptButton,
    CloseLightboxButton,
    SignupTabButton,
    LoginTabButton,
...
class LoginpageUS(BasePage):
    """Class containing actions available
    on United States login page
    """
    ...
    def __init__(self, driver: WebDriver) -> None:
        ...
        if cfg.ENVIRONMENT == "PROD":
            self.base_url = "http://www.birthrightisrael.com/login"
        else:
            self.base_url = "http://www.taglit.info/login"
        ...
        self.btn_signup_submit = SignupSubmitButton(self)
